# https://github.com/pytorch/torchtune/blob/dceaf058b6ddcf676053e48f911a35d0ac5fc0d7/recipes/eleuther_eval.py
...
class _EvalWrapper(HFLM):
    ...
    def tok_encode(self, text: str, **kwargs) -> List[int]:
        ...
        return self._tokenizer.encode(text=text, add_bos=self._add_bos, add_eos=False)
